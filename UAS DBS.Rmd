...
```{r}
# Colors
custom_colors <- viridis::plasma(n = 8)
...
### Employees Work rate {data-width=800}
...
hchart('line', hcaes(x = quarter, y =TotalOrder , group = FirstName)) %>%   hc_add_theme(hc_theme_google()) %>% 
  hc_tooltip(pointFormat = '<b>Number of Sales: </b> {point.y} <br>') %>% 
